...
// }
// 直接在 Rust 中定义这5个常量，替代从 C 桥接
pub const CLINT_ADDR: UBaseType = 0x02000000;
pub const CONFIG_TICK_RATE_HZ: TickType = 1000;
pub const CONFIG_CPU_CLOCK_HZ: UBaseType = 1_000_000;
pub const CONFIG_ISR_STACK_SIZE_WORDS: usize = 2048;
pub const configMAX_PRIORITIES: UBaseType = 7;

lazy_static! {
    pub static ref CONFIG_MTIME_BASE_ADDRESS: UBaseType = CLINT_ADDR + 0xbff8;
    pub static ref CONFIG_MTIMECMP_BASE_ADDRESS: UBaseType = CLINT_ADDR + 0x4000;
    pub static ref portTICK_RATE_MS: TickType = 1000 / CONFIG_TICK_RATE_HZ;
}
